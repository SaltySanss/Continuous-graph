...
/*//-------------------------------------------------------------------- Graphing -------------------------------------------------------------------------------
  for(int i=0; i<= Sample;i++){
    Serial.print((Data[i]*5.0/1023)); // above 0
    Serial.print("\t");
    Serial.println((Data[i]*5.0/1023)-average/Sample); // passs 0
  }
//-------------------------------------------------------------------- Display -------------------------------------------------------------------------------
...
void loop() {
  ...
  float contiunus = analogRead(Voltage);
  Serial.print((contiunus*5.0/1023)); // above 0
  Serial.print("\t");
  Serial.println((contiunus*5.0/1023)-average/Sample); // passs 0
